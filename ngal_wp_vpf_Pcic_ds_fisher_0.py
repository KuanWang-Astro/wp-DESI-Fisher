...
from helpers.CorrelationFunction import ngal_wp_vpf_Pcic_ds_jk
...
def calc_all_observables(param):
    ...
    func,funccov = ngal_wp_vpf_Pcic_ds_jk(pos_gals_d, r_wp, pi_max, r_vpf, vpf_centers, proj_search_radius, cylinder_half_length, pos_gals, ptclpos, particle_masses, rp_bins_ggl, Lbox, args.Nsidejk)
