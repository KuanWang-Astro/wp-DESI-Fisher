...
output_names = ('func_all','param','i')  ##ngal(1)+wp(19)+ggl(20)+vpf(15)+Pcic(70)
...
if __name__ == '__main__':
    main(decorated_hod_model, args.fiducial, args.outfile+'_'+str(seed))
    with open(args.outfile+'_'+str(seed)+'_log','w') as f:
        f.write(sys.argv[0]+'\n')
